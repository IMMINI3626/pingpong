from PingPonglib.protocols.motorprotocol import MotorProtocol
from PingPonglib.protocols.musicprotocol import MusicProtocol
from PingPonglib.protocols.ledmatrixprotocol import LEDMatrixProtocol
from PingPonglib.protocols.cubeprotocol import CubeProtocol
from PingPonglib.protocols.byteutils import ByteUtils
...
class GenerateProtocol(MotorProtocol, MusicProtocol, LEDMatrixProtocol, CubeProtocol):
    ...
    def PingPongGn_connect_bytes(self) -> bytes:
        if self.connection_number == 1: # 1개
            PingPongG1_connect_hexlist = [0xFF, 0xFF, 0x00, 0x07, 0x00, 0x00, 0xCE, 0x00, 0x0E, 0x02, 0x00, 0x00, 0x07, 0x50]
