...
from PingPonglib.protocols.protocolutils import ProtocolUtils
...
class LEDMatrixProtocol():
    ...
    def ArduinoI2CLEDMatrixWritePixel_bytes(self, cube_ID, x_coordinate, y_coordinate, onoff, group_id=None):
        ...
        x_rotation = y_coordinate
        y_rotation = 7-x_coordinate
        hexlist[10] = x_rotation
        hexlist[11] = y_rotation
